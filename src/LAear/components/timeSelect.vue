...
<script>
  ...
  export default{
    ...
    created() {
			if (this.timeDate.type === 'time') {
        this.provsData = this.timeDate.years;
        this.citysData = this.timeDate.months
        this.distsData = this.timeDate.days
        this.select.provs = this.provsData[0]
        this.select.city = this.citysData[0]
        this.select.county = this.distsData[0]
			} else {
        this.provsData = provs_data;
